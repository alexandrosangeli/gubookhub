"""
Django settings for gubookhub_project project.
...
ALLOWED_HOSTS = ['gubookhub.pythonanywhere.com', '127.0.0.1']
...
ROOT_URLCONF = 'gubookhub_project.urls'
...
WSGI_APPLICATION = 'gubookhub_project.wsgi.application'
